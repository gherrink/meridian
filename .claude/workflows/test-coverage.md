...
- **Action**: Run the full test suite to ensure new tests pass and no regressions
- **On failure**: Write errors to `.claude/work/test-errors.md`. If failures are in new tests, re-launch test-writer. If failures are in existing tests, report to user and stop.
